...
export const theme = {
  light: {
    ...
    disabledForeground: colors.grayVeryLight,
    disabledBackground: colors.grayLight,
    highlightColor: colors.black,
    highlightBackground: colors.violetVeryLight,
    scrollbarForeground: colors.grayLight,
    scrollbarBackground: colors.grayVeryLight,
  },
  dark: {
